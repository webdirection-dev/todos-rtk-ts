...
// Типизация createAsyncThunk с использованием Джинерик
// 1й параметр - это то, что ожидаем вернуть из ф-ии, а именно Todo[] - массив с todo
// 2й параметр - это props для payloadCreator - async function(props, {rejectWithValue}) {}
// 3й параметр - это AsyncThunkConfig из файла createAsyncThunk.ts
